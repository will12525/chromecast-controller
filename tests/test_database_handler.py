...
class TestDatabaseHandlerFunctions(TestDatabaseHandler):
    ...
    def test_get_movie_title_list(self):
        ...
        assert result.get("media_list_content_type") == ContentType.MEDIA.value
    ...
    def test_get_tv_show_title_list(self):
        ...
        assert result
        assert isinstance(result, dict)
        assert result.get("media_list_content_type") == ContentType.TV_SHOW.value
        assert isinstance(result.get("media_list"), list)
    ...
    def test_get_tv_show_season_title_list(self):
        ...
        assert result
        assert isinstance(result, dict)
        assert result.get("media_list_content_type") == ContentType.SEASON.value
        assert isinstance(result.get("media_list"), list)
    ...
    def test_get_tv_show_season_metadata(self):
        ...
        assert result
        assert isinstance(result, dict)
        assert result.get("container_content_type") == ContentType.TV_SHOW.value
        assert result.get("id") == 1
